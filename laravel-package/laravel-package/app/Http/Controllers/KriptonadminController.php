...
class KriptonadminController extends Controller
{
    ...
    public function my_wallets()
    {
        ...
        return view('dashboard.my_wallets', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Transactions
    ...
    public function portofolio()
    {
        ...
        return view('dashboard.portofolio', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Market Capital
