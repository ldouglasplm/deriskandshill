								...
								<div id="my-posts" class="tab-pane fade active show">
									<div class="my-post-content pt-3">
										<div class="post-input">
											...
											<a href="javascript:void()" class="btn btn-primary light px-3" data-toggle="modal" data-target="#linkModal"><i class="fa fa-link m-0"></i> </a>
											<!-- Modal -->
											...
											<a href="javascript:void()" class="btn btn-primary light mr-1 px-3" data-toggle="modal" data-target="#cameraModal"><i class="fa fa-camera m-0"></i> </a>
											<!-- Modal -->
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											<img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid w-100">
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											<img src="{{ asset('images/profile/9.jpg') }}" alt="" class="img-fluid w-100">
											<a class="post-title" href="{!! url('/post-details'); !!}"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
											<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
											of spare which enjoy whole heart.</p>
											<button class="btn btn-primary mr-2"><span class="mr-2"><i
