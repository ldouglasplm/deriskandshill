	...
	<div class="row">
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="text-center">
						<img src="{{ asset('images/profile/11.jpg') }}" alt= "" class="rounded ds-img-profile">
						<h4 class="fs-26 mt-sm-3 mt-2 mb-sm-3 mb-0 font-w600 text-black">Johndoe</h4>	
						<p class="mb-0 text-black ">Join on 24 March 2017</p>
						<a href="javascript:(0);" class="btn btn-rounded btn-outline-primary mt-sm-4 mt-2"><i class="fa fa-pencil scale5 mr-3"></i>Edit prorfile</a>
					</div>
					<ul class="d-flex justify-content-center share-icon mt-sm-4 mt-3">
						<li><a href="javascript:(0);"><i class="las la-phone"></i></a></li>
						<li><a href="javascript:(0);"><i class="las la-envelope"></i></a></li>
						<li><a href="javascript:(0);"><i class="lab la-facebook-f"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-6">
							<div class="card border coin-holding-card border-secondary">
								<div class="card-body bg-secondary rounded">
									<div class="d-flex align-items-center">
										<svg class="mr-3" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M21.5567 23.893C21.1992 24.0359 20.8009 24.0359 20.4434 23.893L16.6064 22.3582L21.0001 31.1454L25.3937 22.3582L21.5567 23.893Z" fill="white"/>
											<path d="M20.9998 20.8846L26.2769 18.7739L20.9998 10.3304L15.7227 18.7739L20.9998 20.8846Z" fill="white"/>
										...
										<div>
											<h4 class="font-w500 text-white title mb-0">Ethereum</h4>
											<span class="text-white fs-14 op7">ETH</span>
										</div>
									</div>
								...
								<div class="card-footer d-flex justify-content-between border-0">
									...
									<a href="javascript:void(0);" class="underline text-primary font-w500 footer-info">More Details</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="card border coin-holding-card border-warning">
								<div class="card-body bg-warning rounded">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="font-w500 text-white title mb-0">Bitcoin</h4>
											<span class="text-white fs-14 op7">BTC</span>
										</div>
									</div>
									<div class="d-flex flex-wrap mt-4 align-items-center">	
										<div class="d-flex align-items-center mr-auto pr-3 mb-2">
							...
							<div class="card border coin-holding-card border-info">
								<div class="card-body bg-info rounded">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="font-w500 text-white title mb-0">Digital Cash</h4>
											<span class="text-white fs-14 op7">DASH</span>
										</div>
									</div>
									<div class="d-flex flex-wrap mt-4 align-items-center">	
										<div class="d-flex align-items-center mr-auto pr-3 mb-2">
							...
							<div class="card border coin-holding-card border-primary">
								<div class="card-body bg-primary rounded">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="font-w500 text-white title mb-0">Zcash</h4>
											<span class="text-white fs-14 op7">ZEC</span>
										</div>
									</div>
									<div class="d-flex flex-wrap mt-4 align-items-center">	
										<div class="d-flex align-items-center mr-auto pr-3 mb-2">
		...
		<div class="col-xl-6">
			<div class="row">
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header flex-wrap d-block d-sm-flex border-0 pb-2">
							<div class="mb-3">
