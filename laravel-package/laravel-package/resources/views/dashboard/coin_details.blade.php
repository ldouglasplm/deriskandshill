	...
	<div class="d-flex flex-wrap mb-3">
		...
		<div class="card-action coin-tabs mb-3">
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a class="nav-link bg-warning" data-toggle="tab" href="#Bitcoin" role="tab" aria-selected="false">
				...
				<li class="nav-item">
					<a class="nav-link bg-secondary" data-toggle="tab" href="#Ethereum" role="tab" aria-selected="false">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li class="nav-item">
					<a class="nav-link active  bg-info" data-toggle="tab" href="#Dash" role="tab" aria-selected="true">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li class="nav-item">
					<a class="nav-link  bg-primary" data-toggle="tab" href="#Litecoin" role="tab" aria-selected="true">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="text-center mb-3">
								<img class="mb-3" src="{{ asset('images/svg/btc.svg') }}" alt="">
								<h2 class="fs-24 font-w600 text-black mb-0">Digital Cash</h2>
								<p class="fs-14 font-w600 text-black">BTC</p>
								<span class="text-primary fs-14">1 BTC = 68.48 USD</span>
							</div>
					...
					<div class="card">
						<div class="card-header d-sm-flex d-block pb-0 border-0">
							...
							<div class="dropdown custom-dropdown d-block mt-3 mt-sm-0 mb-0">
								<div class="btn btn-rounded border border-warning btn-sm d-flex align-items-center svg-btn" role="button" data-toggle="dropdown" aria-expanded="false">
									...
									<div class="text-left mr-3 ml-3">
										<span class="d-block fs-16 text-black">45,662.05 BTC</span>
									</div>
									<i class="fa fa-angle-down scale5 ml-3 mr-3"></i>
								</div>
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="javascript:void(0);">345,455 BTC</a>
									<a class="dropdown-item" href="javascript:void(0);">789,123 BTC</a>
								</div>
							</div>
						</div>
						<div class="card-body">
			...
			<div class="row">
				<div class="col-xl-3 col-xxl-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="text-center mb-3">
								<img class="mb-3" src="{{ asset('images/svg/eth.svg') }}" alt="">
								<h2 class="fs-24 font-w600 text-black mb-0">Digital Cash</h2>
								<p class="fs-14 font-w600 text-black">ETH</p>
								<span class="text-primary fs-14">1 ETH = 68.48 USD</span>
							</div>
							<p class="fs-14">Dash is an open source cryptocurrency. It is an altcoin that was forked from the Bitcoin protocol. It is also a decentralized autonomous organization (DAO) run by a subset of its users, which are called "masternodes". The currency permits transactions that can be untraceable.</p>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="card">
								...
								<div class="card-body p-3">
									<div class="table-responsive">
										<table class="table text-center bg-secondary-hover tr-rounded">
											<thead>
												<tr>
													<th class="text-left">Price</th>
													<th class="text-center">Amount</th>
				...
				<div class="col-xl-6 col-xxl-12">	
					<div class="card">
						<div class="card-header d-sm-flex d-block pb-0 border-0">
							...
							<div class="dropdown custom-dropdown d-block mt-3 mt-sm-0 mb-0">
								<div class="btn btn-rounded border border-secondary btn-sm d-flex align-items-center svg-btn" role="button" data-toggle="dropdown" aria-expanded="false">
									<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M21.5711 24.072C21.2049 24.2183 20.797 24.2183 20.4309 24.072L16.501 22.5L21.001 31.5L25.501 22.5L21.5711 24.072Z" fill="#DC3CCC"/>
										<path d="M20.999 21L26.999 18.9001L20.999 10.5L14.999 18.9001L20.999 21Z" fill="#DC3CCC"/>
										<path d="M21 0C9.40205 0 0 9.40205 0 21C0 32.598 9.40205 42 21 42C32.598 42 42 32.598 42 21C41.9872 9.40754 32.5925 0.0128174 21 0V0ZM29.8417 20.171L22.3417 35.1711C21.9714 35.9122 21.07 36.2125 20.3294 35.8421C20.0387 35.697 19.8034 35.4617 19.6583 35.1711L12.1583 20.171C11.9253 19.7032 11.9518 19.1479 12.2283 18.7043L19.7283 6.70444C20.2268 6.00222 21.1996 5.83651 21.9018 6.33502C22.0451 6.43664 22.17 6.56116 22.2717 6.70444L29.7712 18.7043C30.0482 19.1479 30.0747 19.7032 29.8417 20.171V20.171Z" fill="#DC3CCC"/>
									</svg>
									<div class="text-left mr-3 ml-3">
										<span class="d-block fs-16 text-black">45,662.05 ETH</span>
									</div>
			...
			<div class="row">
				<div class="col-xl-3 col-xxl-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="text-center mb-3">
								<img class="mb-3" src="{{ asset('images/svg/dash.svg') }}" alt="">
								<h2 class="fs-24 font-w600 text-black mb-0">Digital Cash</h2>
								<p class="fs-14 font-w600 text-black">DASH</p>
								<span class="text-primary fs-14">1 DASH = 68.48 USD</span>
							</div>
							<p class="fs-14">Dash is an open source cryptocurrency. It is an altcoin that was forked from the Bitcoin protocol. It is also a decentralized autonomous organization (DAO) run by a subset of its users, which are called "masternodes". The currency permits transactions that can be untraceable.</p>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-xl-3 col-xxl-4">
					<div class="card">
						...
						<div class="card-body">
							<div class="text-center mb-3">
								<img class="mb-3" src="{{ asset('images/svg/ltc.svg') }}" alt="">
								<h2 class="fs-24 font-w600 text-black mb-0">Digital Cash</h2>
								<p class="fs-14 font-w600 text-black">LTC</p>
								<span class="text-primary fs-14">1 LTC = 68.48 USD</span>
							</div>
							<p class="fs-14">Dash is an open source cryptocurrency. It is an altcoin that was forked from the Bitcoin protocol. It is also a decentralized autonomous organization (DAO) run by a subset of its users, which are called "masternodes". The currency permits transactions that can be untraceable.</p>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="card">
								...
								<div class="card-body p-3">
									<div class="table-responsive">
										<table class="table text-center bg-primary-hover tr-rounded">
											<thead>
												<tr>
													<th class="text-left">Price</th>
													<th class="text-center">Amount</th>
