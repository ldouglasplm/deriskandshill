	...
	<div class="row">
		<div class="col-xl-12">
			<div class="table-responsive table-hover fs-14">
				<table class="table display mb-4 dataTablesCard short-one  card-table text-black" id="example-5">
					<thead>
						<tr>
							<th>
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="{{ asset('images/table/1.jpg') }}"  class="rounded-circle mr-2 width40 height40" alt="">
									<span>Samuel</span>
								</div>
							</td>
							<td class="wspace-no">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="{{ asset('images/table/2.jpg') }}"  class="rounded-circle mr-2 width40 height40" alt="">
									<span>Cindy</span>
								</div>
							</td>
							<td class="wspace-no">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<img src="{{ asset('images/table/3.jpg') }}"  class="rounded-circle mr-2 width40 height40" alt="">
									<span>Marquezz</span>
								</div>
							</td>
							<td class="wspace-no">
