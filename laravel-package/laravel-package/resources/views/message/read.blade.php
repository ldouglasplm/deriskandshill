									...
									<div class="read-content">
										<div class="media pt-3 d-sm-flex d-block justify-content-between">
											<div class="clearfix mb-3 d-flex">
												<img class="mr-3 rounded" width="50" height="50" alt="image" src="{{ asset('images/avatar/1.jpg') }}">
											...
											<div class="clearfix mb-3">
												<a href="javascript:void()" class="btn btn-primary px-3 light mr-2 my-1"><i class="fa fa-reply"></i> </a>
												<a href="javascript:void()" class="btn btn-primary px-3 light mr-2 my-1"><i class="fa fa-long-arrow-right"></i> </a>
												<a href="javascript:void()" class="btn btn-primary px-3 light mr-2 my-1"><i class="fa fa-trash"></i></a>
											</div>
										</div>
										<hr>
